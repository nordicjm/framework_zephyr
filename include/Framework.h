...
//=============================================================================
// Prevent unused x warnings in IAR
//=============================================================================
...
//!          Caller is responsible for freeing memory, if status isn't success.
//!
...
// This is for backward compatibility.  Zephyr's __ASSERT_EVAL could be used
// instead.
#if FWK_DEBUG
